# Successor pointer: future ETL-component spec (`016-release-unique-view-materialization`)
...
- Live under `specs/016-release-unique-view-materialization/` (or whichever number is next available at that time).
...
- **Spec number**: `016-release-unique-view-materialization` (provisional; may be renumbered when actually opened depending on what other specs land first).
